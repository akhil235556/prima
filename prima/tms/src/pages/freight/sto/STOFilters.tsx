...
import { stoOptions } from "../../../base/constant/ArrayList";
...
import { blockPlaceholder, blockTitle, districtPlaceholder, districtTitle, maxDistanceLabel, maxDistancePlaceholder, minDistanceLabel, minDistancePlaceholder, zonePlaceholder, zoneTitle } from "./base/stockTransferOrderMessageUtils";

interface SOFiltersProps {
    open: boolean,
    onClose: any,
    onApplyFilter: any
    filerChips: any,
...
function SOFilters(props: SOFiltersProps) {
