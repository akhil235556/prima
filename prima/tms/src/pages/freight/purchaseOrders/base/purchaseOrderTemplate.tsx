...
export const poTableColumn = (onClickViewButton: Function, onClickSourceButton: Function, tabName: string) => {
    ...
    isMobile && columnList.push({
        id: 'po-product', label: 'See More', buttonLabel: "PO", type: "expand", leftIcon: <ArrowForward />,
    })

    return columnList;
};

export const poBulkTableColumn = (handleChecks: Function, handleAllChecks: Function, allValue: boolean, onClickSourceButton: Function, tabName: string) => {
    const columnList: ColumnStateModel[] = [
        {
...
export const poDemandOrderTableColumn = (onClickDemandButton: Function, onClickApprove: Function, onClickModifyAccept: Function, onClickModifyReject: Function, onClickEdit: Function, onClickDelete: Function, status: string) => {
    const columnList: ColumnStateModel[] = [
        {
...
export const poDemandOrderChildrenTableColumn = () => {
    const columnList: ColumnStateModel[] = [
