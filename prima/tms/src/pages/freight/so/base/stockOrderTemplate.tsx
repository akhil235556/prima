...
export const soTableColumn = (onClickViewButton: Function, onClickSourceButton: Function, tabName: string) => {
    ...
    if (tabName === stockTransferStatusEnum.PENDING) {
        columnList.push(
            {
    ...
    isMobile && columnList.push({
        id: 'so-product', label: 'See More', buttonLabel: "SO", type: "expand", leftIcon: <ArrowForward />,
    })
    return columnList;
};

export const soBulkTableColumn = (handleChecks: Function, handleAllChecks: Function, allValue: boolean, onClickSourceButton: Function, tabName: string) => {
    const columnList: ColumnStateModel[] = [
        {
...
export const soDemandOrderTableColumn = (onClickDemandButton: Function, onClickApprove: Function, onClickModifyAccept: Function, onClickModifyReject: Function, onClickEdit: Function, onClickDelete: Function, status: string) => {
    const columnList: ColumnStateModel[] = [
        {
...
export const soDemandOrderChildrenTableColumn = () => {
    const columnList: ColumnStateModel[] = [
        {
            id: 'productName', label: 'Product Name', format: (value: any) => value || ".....",
        },
