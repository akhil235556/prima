...
import {
    ...
    placementDateTimePlaceholder, remarkLabel, ShipmentTagLabel, ShipmentTagPlaceholder, tatLabelWithoutUnit,
...
import { Context } from '../raiseOrders/CreateOrder';
...
function ShipmentOrder(props: ShipmentOrderProps) {
    const { onDelete, details, dropPointList, pickupPointList, servicabiltyTat, DODetails, doMaterialResponse, shipmentTagList } = props;
                ...
                <div className=" shipment_Details row custom-form-row align-items-end">
                    ...
                    <div className="col-md-4 form-group">
                        <AutoComplete
                            ...
                            noOptionsMessage={() => noLocationForZone}
                        />
                    </div>
                    <div className="col-md-4 form-group">
                        <AutoComplete
                    ...
                    <div className="col-md-4 form-group">
                        <AutoSuggest
                            ...
                            isDisabled={DODetails}
                            value={DODetails ? DODetails.consigneeName : details.details.consigneeName}
                    ...
                    <div className="form-group col-md-4">
                        <AutoComplete
                            ...
                            error={details.error.shipmentTagValue}
                        ...
                        <RenderArticles
                            ...
                            onSelectArticle={(article: any, articlesIndex: number) => {
                                ...
                                saveDetails({
                                    ...details.details,
                                    articles: articles,
                                    // length: article.data && article.data.length,                                    // width: article.data && article.data.width,
