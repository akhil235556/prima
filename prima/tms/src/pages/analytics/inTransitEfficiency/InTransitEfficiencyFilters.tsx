...
interface InTransitEfficiencyFiltersProps {
    open: boolean,
    onClose: any,
    onApplyFilter: any,
    filerChips: any,
...
function InTransitEfficiencyFilters(props: InTransitEfficiencyFiltersProps) {
...
export default InTransitEfficiencyFilters;
