...
interface VehiclePlacementReportFiltersProps {
    open: boolean,
    onClose: any,
    onApplyFilter: any,
    filerChips: any,
...
function VehiclePlacementReportFilters(props: VehiclePlacementReportFiltersProps) {
...
export default VehiclePlacementReportFilters;
