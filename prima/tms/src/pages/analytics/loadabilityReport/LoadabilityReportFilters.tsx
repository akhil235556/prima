...
interface LoadabilityReportFiltersProps {
    open: boolean,
    onClose: any,
    onApplyFilter: any,
    filerChips: any,
...
function LoadabilityReportFilters(props: LoadabilityReportFiltersProps) {
            ...
            <div className="filter-form-row">
                ...
                <div className="form-group">
                    <AutoSuggest
                        ...
                        onSelected={(element: OptionType) => {
                            setValues({ destinationLocationName: element.label }, { locationCode: element.value });
                        }}
                        onChange={(text: string) => {
                            setValues({ destinationLocationName: text }, { locationCode: "" });
                        }}
                    />
                </div>
    ...
    function onApply() {
        if (!isFilterNullValue(filterValues.partnerName) && isNullValue(filterParams.partnerCode)) {
            ...
            return;
        } else if (!isFilterNullValue(filterValues.destinationLocationName) && isNullValue(filterParams.locationCode)) {
...
export default LoadabilityReportFilters;
