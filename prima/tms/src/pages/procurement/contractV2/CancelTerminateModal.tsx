...
import { cancelContractWarning } from "../../../base/constant/MessageUtils";
...
function CancelTerminateModal(props: CancelAgnModalProps) {
    ...
    return (
        ...
        >
            <div className="text-center">
                ...
                <label>{cancelContractWarning}</label>
            </div>
        </ModalContainer>
    );
}

export default CancelTerminateModal;
