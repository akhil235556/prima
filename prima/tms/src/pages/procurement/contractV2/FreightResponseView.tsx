...
import { contractModeType, rowsPerPageOptions } from '../../../base/constant/ArrayList';
import { destinationLabel, originLabel } from '../../../base/constant/MessageUtils';
...
const FreightResponseView = (props: FreightResponseViewProps) => {
    ...
    return (
        <div className='FreightResponseView'>
                ...
                }} />
            {
                contractDetails.contractType === "PTL" ? freightResponse.map((item: any, index: number) => (
                    <div className="contract-detail-wrap" key={item.id}>
                            ...
                            <Collapse in={details[index]} timeout="auto" unmountOnExit>
                                <CardContent className="creat-contract-content">
                                    <div className="row custom-form-row">
                                        {contractDetails?.contractMode === contractModeType.ZONE ? <>
