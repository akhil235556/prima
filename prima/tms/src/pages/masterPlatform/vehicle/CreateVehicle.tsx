...
import {
    ...
    dedicatedLabel,
    pucNumberHint, pucNumberHintPlaceholder, rcCopyHint, rcCopyHintPlaceholder, registrationNumberHint, transporterLabel, transporterPlaceHolder, vehicleRegistrationNumberPlaceHolder, vehicleTypeLabel,
...
import { createVehicle, getVehicleDetails, getVehicleTemplate, searchPlatformVehicle, updateVehicleDetails } from '../../../serviceActions/VehicleServiceActions';
...
function CreateVehicle() {
    ...
    let editMode: boolean = !isObjectEmpty(location.state) ? true : false;
    const appDispatch = useDispatch();
    const [params, setParams] = React.useState<Vehicle>(vehicleElementData);
    const [error, setError] = React.useState<any>({});
    const selectedElement: any = location?.state?.selectedElement
            ...
            appDispatch(getVehicleDetails(params)).then((response: any) => {
                if (response) {
                    ...
                    setParams({
                        ...
                        partnerCode: selectedElement?.partnerCode ? selectedElement?.partnerCode : "",
    ...
    }, [selectedElement, vehicleTemplate]);
    ...
    useEffect(() => {
        appDispatch(getVehicleTemplate({ isRequired: 1 })).then((response: any) => {
            if (response) {
    ...
    return (
        <><div className="filter-wrap">
            <Filter
                pageTitle={editMode ? "Vehicle Details" : "Create Vehicle"}
                ...
                <Card className="creat-contract-wrapp creat-wrapp">
                    ...
                    {loading ?
                        ...
                        <CardContent className="creat-contract-content">
                            <div className="custom-form-row row row align-items-end">
                                ...
                                <div className="form-group col-md-4 gst-line">
