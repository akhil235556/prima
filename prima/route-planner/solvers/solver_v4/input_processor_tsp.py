...
class SolverTSPInputDataProcessor(object):
    ...
    def __init__(self, orders, vehicles, all_vehicles, products, config):
        self.orders = orders
        ...
        SolverTSPInputDataProcessor.type_cast_to_str(self.orders, self.task_str_header)
        SolverTSPInputDataProcessor.type_cast_to_str(self.vehicles, self.vehicles_str_header)
        SolverTSPInputDataProcessor.type_cast_to_str(self.products, self.products_str_header)
    ...
    def num_vehicles(vehicles):
        vehicles['No. of vehicles'] = vehicles['No. of vehicles'].fillna(1)
    ...
    @staticmethod
    def get_all_vehicle_cost_per_km_list(all_vehicles):
        cost_km_list = all_vehicles["per_km_charges"].values.tolist()
    ...
    @staticmethod
    def get_all_vehicle_cost_per_kg_list(all_vehicles):
        cost_kg_list = all_vehicles["per_kg_charges"].values.tolist()
        return cost_kg_list
    ...
    def create_data_model(self):
        ...
        all_vehicle_cost_per_km_list = self.get_all_vehicle_cost_per_km_list(self.all_vehicles)
        vehicle_cost_per_kg_list = self.get_vehicle_cost_per_kg_list(self.vehicles)
        all_vehicle_cost_per_kg_list = self.get_all_vehicle_cost_per_kg_list(self.all_vehicles)
        ...
        all_vehicle_data = {
            ...
            "cost_per_km": all_vehicle_cost_per_km_list,
            "cost_per_kg": all_vehicle_cost_per_kg_list,
