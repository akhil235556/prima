...
from route_planner.vrp.sku_fixed_cost_planner.validator.products_validator import ProductsValidator
from route_planner.vrp.sku_fixed_cost_planner.validator.task_validator import TaskValidator
from route_planner.vrp.sku_fixed_cost_planner.validator.vehicles_validator import VehiclesValidator
...
class MultiProductUploadValidation(object):
    ...
    def process_main(self):
        ...
        for idx, task_df in enumerate(task_df_list):
            ...
            try:
                ...
                vehicles_df = MultiProductUploadValidation.filter_vehicle(_vehicles_df, from_city, to_city)
                ...
                configuration = SkuFixedSolverConfigurationV1.get_default_sku_fixed_configuration()
                ...
                planner = SolverV1(
                    ...
                    search_time_limit=self.search_time_limit, from_city=from_city, to_city=to_city)
    ...
    def df_to_csv(idx, df, validator):
        rid, path = MultiProductUploadValidation.get_path(validator.SHEET, validator.rid, idx)
