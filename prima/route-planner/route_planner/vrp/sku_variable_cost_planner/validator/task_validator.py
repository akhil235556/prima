...
from route_planner.vrp.sku_variable_cost_planner.validator.time_window_validator import TimeWindowValidator
...
class TaskValidator(BaseValidator):
    ...
    OUT_HEADER = ['order_id', 'from_location', 'from_latitude', 'from_longitude', 'to_location', 'to_latitude',
                  ...
                  'operating_window_from', 'operating_window_to', 'loading_time', 'unloading_time', 'priority',
                  'sku', 'sku_tag', 'serviceable_vehicles', 'from_city', 'to_city', 'task_id']
    ...
    MANDATORY_COLS = ['From Location*', 'From Latitude*', 'From Longitude*',
                      'To Location*', 'To Latitude*', 'To Longitude*']

    NUMBER_TYPE_COLS = ['From Latitude*', 'From Longitude*', 'To Latitude*', 'To Longitude*',
                        'Loading Time (Hours)', 'Unloading Time (Hours)', 'Load (kg)', 'Volume (cbm)', 'SLA (Hours)',
                        'Priority']

    STRING_TYPE_COLS = ['Order ID*', 'From Location*', 'To Location*', 'From City', 'To City', 'Serviceable Vehicles',
                        'SKU', 'Tag']
