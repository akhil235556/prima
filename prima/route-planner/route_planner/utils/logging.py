...
def context_logging(func):
    ...
    def set_context_in_thread(*args, **kwargs):
        ...
        return func(logging_rid=request_id, *args, **kwargs)
...
def context_logging_method(_rid=None):
    if not _rid:
        _rid = generate_request_id()
    _CustomLogManager.set_extra(_rid)
    return _rid


__all__ = ['CustomLogger', 'getLogger', 'context_logging', 'context_logging_method']
