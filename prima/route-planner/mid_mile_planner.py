...
from route_planner.vrp.mid_mile_cost_planner.mid_mile_cost_validator import \
    MidMileUploadValidation
...
if __name__ == '__main__':
    ...
    try:
        ...
        validator = MidMileUploadValidation(filename, _rid, None)
        resp = validator.process()
